...
<body>
    <div class="login-wrapper">
        ...
        <div class="login-brand">
            <img src="admin/dist/img/<?= htmlspecialchars($systemLogo) ?>" alt="شعار النظام"
        ...
        <div class="login-form-side">
            ...
            <?php if ($message): ?>
                <div class="alert alert-<?= $alertType ?>">
                    <i class="fas fa-<?= $alertType === 'danger' ? 'exclamation-circle' : 'exclamation-triangle' ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" id="emailInput" name="email" class="form-control"
                            placeholder="example@domain.com" value="<?= $email_val ?>" <?= $locked ? 'disabled' : '' ?>
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" id="passwordInput" name="password" class="form-control"
                            placeholder="••••••••" <?= $locked ? 'disabled' : '' ?> required>
